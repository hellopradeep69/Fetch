CC = g++
CFLAGS = -std=c++23 -Wall -Wextra -O3  -flto -funroll-loops -fomit-frame-pointer ##-march=native -mtune=native uncomment this if u dont want portabilty but performance
TARGET=fetch
